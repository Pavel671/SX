            ...
            if (msg instanceof Message) {
                ...
                if (messageFromClient.getType().equals(MessageType.REGISTRATION) && !clientConnected){
                    ...
                    try {
                        ...
                        DBManager.insertIntoTable(Integer.parseInt(name), Integer.parseInt(password), timeWhenAdd, timeWhenAdd);
                        ...
                        ConsoleHelper.writeMessage(Server.connectionUsersMap.toString());
